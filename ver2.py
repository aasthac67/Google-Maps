...
def find_places(tree,name,d):
	...
	plt.clf()
	plt.scatter(d[0], d[1], label="My Location", color= "black",marker= "^", s=30)
...
def main():
	...
	# my location
	plt.scatter(d[0], d[1], label="MY_location", color="black", marker= "^", s=30)
	plt.legend() 
	...
	if choice==1:
		find_places(p_tree,"police_stations",d)
	elif choice==2:
		find_places(h_tree,"hotels",d)
	elif choice==3:
		find_places(s_tree,"school",d)
	elif choice==4:
		find_places(pe_tree,"petrol_bunks",d)
	elif choice==5:
		find_places(ho_tree,"hospitals",d)
	else:
		print("wrong choice!")
